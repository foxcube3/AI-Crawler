...
if ($Native) {
  ...
  # PyInstaller build
  $pyiArgs = @("-m","PyInstaller","--noconfirm","--clean","--onefile","--name","AI_Crawler_Assistant_Server","--add-data","templates;templates","--add-data","data;data","--collect-data","dateparser","server.py")
